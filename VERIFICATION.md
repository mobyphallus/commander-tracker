...
`cargo test --offline --bin commander_pod`: 115 passed, 1 ignored (live network).
...
where N is 0 (1875×1205), 1 (800×1280), or 2 (1280×800). Each run captures fourteen
states including recovery, game dialogs, search keyboard, result correction,
stats, restore confirmation, rematch setup, and partner damage controls.
