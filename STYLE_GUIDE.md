...
- Bracket and salt scores pair a tier-stack icon and a salt-shaker icon with their numeric values and labels. Keep both icons consistent between deck tiles and the analysis screen.
